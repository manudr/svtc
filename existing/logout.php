...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td width="226%" align="left" valign="top" class="headingmain_txt">Logout</td>
  </tr>
  
  <tr>
    <td align="center" valign="top" style="padding-left:10px;"><h4 style="color:#0000FF"><?php echo $message; ?></h4></td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:10px;">&nbsp;</td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:10px;font-size:14px"><center><a href="homepage.php">Back to Home Page</a> </center></td>
  </tr>
  <tr>
    <td align="left" valign="top" style="padding-left:10px;">&nbsp;</td>
  </tr>
