...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td width="226%" align="left" valign="top" class="headingmain_txt">Event Addition Confirmation</td>
  </tr>
  <tr>
...
$selectquery="select * from upcomingevents";
...
{
	$query="insert into upcomingevents values ('".$description."')";
	mysql_query($query) or die('Error updating the DB' . mysql_error());
	mysql_close();
}
echo "<font style='color:#2f7d10;font-weight:bold;font-size:12px'>Received the following event  and inserted into DB</font>";
...
?>
  ...
  <tr><td align="center" style="padding-top:20px;padding-bottom:20px;"><a href='manageevents.php'>Back to Events</a></td></tr>
</table>
