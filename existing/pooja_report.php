...
"date(a.date_of_service) >= date('$startdate') and date(a.date_of_service) <= date('$enddate') and a.service_id = b.service_id and a.user_name = c.user_name " .
"and c.member_id = d.member_id and a.gothram_id = e.gothram_id and a.nakshatram_id = f.nakshatram_id order by a.date_of_service";
