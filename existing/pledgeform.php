...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
    <td width="226%" align="left" valign="top" class="headingmain_txt">Pledge Forms</td>
  </tr>
  <tr>
   <td align="left" valign="top" style="padding-left:10px;" class="txtLink">
	<span style="white-space:nowrap"><a href="/Pledge documents/PledgeForm.pdf"> Click here </a> to download the pledge form.</span>
	</td>
  </tr>
</table>
